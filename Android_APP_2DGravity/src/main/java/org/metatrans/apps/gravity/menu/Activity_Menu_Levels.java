...
public class Activity_Menu_Levels extends Activity_Base {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bitmap_stars_0 = BitmapUtils.fromResource(this, org.metatrans.commons.graphics2d.R.drawable.ic_stars_0, getIconSize());
		bitmap_stars_1 = BitmapUtils.fromResource(this, org.metatrans.commons.graphics2d.R.drawable.ic_stars_1, getIconSize());
		bitmap_stars_2 = BitmapUtils.fromResource(this, org.metatrans.commons.graphics2d.R.drawable.ic_stars_2, getIconSize());
		bitmap_stars_3 = BitmapUtils.fromResource(this, org.metatrans.commons.graphics2d.R.drawable.ic_stars_3, getIconSize());
		bitmap_locked  = BitmapUtils.fromResource(this, org.metatrans.commons.R.drawable.ic_gift_locked, getIconSize());
...
//					DateUtils.formatElapsedTime(elapsedSeconds)
					...
					Toast_Base.showToast_InCenter_Long(Activity_Menu_Levels.this,
							//"\r\n"
							//"\r\n"
							Application_Base.getInstance().getString(org.metatrans.commons.R.string.unlock_level_1) + " ?"
							+ "\r\n"
							+ "\r\n"
							+ " > " + Application_Base.getInstance().getString(org.metatrans.commons.R.string.unlock_level_2) + " " + position
							+ "\r\n"
							+ "\r\n"
							+ "             "
							+ Application_Base.getInstance().getString(org.metatrans.commons.R.string.or)
							+ "\r\n"
							+ "\r\n"
							+ " > " + Application_Base.getInstance().getString(org.metatrans.commons.R.string.unlock_level_3) + " " + wait_time
							//+ "\r\n"
							//+ "\r\n"
							);
