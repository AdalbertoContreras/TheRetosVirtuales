...
public abstract class View_Main_Base extends View_Surface_Base {
	...
	public View_Main_Base(Activity_Main_Base2D activity) {
		...
		if (bitmap_pause == null) {
			...
			bitmap_replay				= BitmapUtils.fromResource(getContext(), org.metatrans.commons.R.drawable.ic_action_replay);
			bitmap_new					= BitmapUtils.fromResource(getContext(), org.metatrans.commons.R.drawable.ic_action_replay);
			bitmap_menu 				= BitmapUtils.fromResource(getContext(), R.drawable.ic_action_settings);
			bitmap_next					= BitmapUtils.fromResource(getContext(), org.metatrans.commons.R.drawable.ic_action_next);
			bitmap_star					= BitmapUtils.fromResource(getContext(), org.metatrans.commons.R.drawable.ic_star_gold);
	...
	protected void initializeDimensions() {
		...
		textarea_top_center1_gameover 				= new TextArea(rectf_top_center, true,
				Application_Base.getInstance().getString(org.metatrans.commons.R.string.game_over),
