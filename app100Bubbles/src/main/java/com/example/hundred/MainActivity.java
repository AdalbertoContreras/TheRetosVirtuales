...
public class MainActivity extends AppCompatActivity implements
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        if (id == R.id.bonusSwipe) {
            ...
            accionPiso = 0;
            gestureDetector.onTouchEvent(event);
        } else if (id == R.id.ca10) {
            jugadaColumnaPosible = 2;
            jugadaColumnaTap = 2;
            accionPiso = 0;
            gestureDetector.onTouchEvent(event);
        } else if (id == R.id.ca11) {
            jugadaColumnaPosible = 3;
            jugadaColumnaTap = 3;
            accionPiso = 0;
            gestureDetector.onTouchEvent(event);
        } else if (id == R.id.ca12) {
            jugadaColumnaPosible = 4;
            jugadaColumnaTap = 4;
            accionPiso = 0;
            gestureDetector.onTouchEvent(event);
        } else if (id == R.id.ca15) {
            longPress = false;
            singleTap = false;
            longPressPlus = true;
            singleTapSwipeZone = false;
